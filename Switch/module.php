...
#			$this->RegisterVariableInteger("Countdown", "Countdown", "", 30);

			
			$this->EnableAction("Power");	
#			$this->EnableAction("Countdown");	
		...
		public function RequestAction($Ident, $Value)
		{
			...
			switch($Ident) {
		  	case "Power":
				...
				break;
#		  	case "Countdown":	
#				$payload = [ 'code' => 'countdown_1' , 'value' => $Value ];		// *10 {"min":10,"max":1000,"scale":0,"step":1}
#				$ret = $this->CPost($payload);
#				break;
 			break;
		...
		public function updateState()
		{
			...
			//countdown_1
#			$key = array_search('countdown_1', array_column($return->result, 'code'));
#            $countdown = (int)$return->result[$key]->value;
#            SetValue($this->GetIDForIdent("Countdown"), $countdown);
		}
